...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |-----------------------------------------------------------|
     * |Ctrl|Alt |Win |Space     |Fn  |Space   |Caps|    |    |    |
     * '-----------------------------------------------------------'
     */
    [_BL] = LAYOUT_60_ansi_split_space_rshift(
        ...
        KC_LCTL, KC_LALT, KC_LGUI, KC_SPC,                    MO(_FL), KC_SPC,                    KC_CAPS, XXXXXXX, XXXXXXX, XXXXXXX
    ),
     ...
     * |-----------------------------------------------------------|
     * |     |Prv|Ply|Nxt|   |   |Hom|PgD|PgU|End|PSc|`~ |~  |     |
     * |-----------------------------------------------------------|
     * |      |Vl-|Mut|Vl+|   |   |Lft|Dwn|Up |Rgt|   |   |        |
     * |-----------------------------------------------------------|
     * |        |Br-|Br+|   |   |   |   |   |   |   |   |      |Arr|
     * |-----------------------------------------------------------|
     * |    |    |    |          |    |        |    |    |    |    |
    ...
    [_FL] = LAYOUT_60_ansi_split_space_rshift(
        ...
        _______,          KC_SLCK, KC_PAUS, _______, _______, _______, _______, _______, _______, _______, _______, _______, TG(_AL),
